...
async fn main() -> Result<(), reqwest::Error> {
    ...
    // curl -H "X-Secret: 7c786e53dbde397a6fa3d960b24c9cc79d2b9b33dd1141ac958bfd58dfd954df" "https://api.pons.com/v1/dictionary?l=deen&q=house"
    ...
    let request = request_builder.header(
        "X-Secret",
        "7c786e53dbde397a6fa3d960b24c9cc79d2b9b33dd1141ac958bfd58dfd954df",
    );
